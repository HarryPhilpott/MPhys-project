...
Sn.append('C^(+1.0)k^(+2.0)x^(+0.0)')           #C = -1/6, D = 1/120, E = 14/120, F = -1/(7!), G = -135/(7!) H = 1/(9!), I = 1228/(9!), J = 5478/(9!)

Sn.append('D^(+1.0)k^(+0.0)x^(+0.0)')
Sn.append('E^(+1.0)k^(+2.0)x^(+0.0)')
Sn.append('D^(+1.0)k^(+4.0)x^(+0.0)')

Sn.append('F^(+1.0)k^(+0.0)x^(+0.0)')
Sn.append('G^(+1.0)k^(+2.0)x^(+0.0)')
Sn.append('G^(+1.0)k^(+4.0)x^(+0.0)')
Sn.append('F^(+1.0)k^(+6.0)x^(+0.0)')

Sn.append('H^(+1.0)k^(+0.0)x^(+0.0)')
Sn.append('I^(+1.0)k^(+2.0)x^(+0.0)')
Sn.append('J^(+1.0)k^(+4.0)x^(+0.0)')
Sn.append('I^(+1.0)k^(+6.0)x^(+0.0)')
Sn.append('H^(+1.0)k^(+8.0)x^(+0.0)')
...
for j in range(1,10):
    ...
    write(str(1), k_val)
    write(str(term2_col_terms[0]), k_val)
    write(str(term3_col_terms[0]), k_val)
    write(str(term4_col_terms[0]), k_val)
    write(str(term5_col_terms[0]), k_val)
